...
export default function HeroCard({ title, description, icon, color }) {
    return (
        <button className="hero-card bg-indigo-200 p-4 rounded-lg shadow-md flex flex-row items-center justify-evenly space-x-4 hover:shadow-lg transition-shadow duration-300 w-[25rem]">
